...
const Update = () => {
    ...
    return (
        <form onSubmit={submitHandler} className='w-[350px] font-display max-h-[600px] p-3 flex flex-col bg-darkGrey'>
            <h1 className='text-white'>{(animeData?.media?.title?.english)}</h1>
            <img src={animeData?.media?.bannerImage} className='mt-2 rounded-sm' alt="" />
